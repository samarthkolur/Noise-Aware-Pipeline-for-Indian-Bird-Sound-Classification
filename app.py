...
def main() -> None:
    ...
    if autoencoder is not None:
        ...
        st.caption(f"AE gating enabled: recon_threshold={recon_threshold:.6f}")
    else:
        ...
        st.write(
            {
                ...
                "pred_label": label,
                "prob": prob,
                "note": "If this is Bird, you need white-noise-like examples in the noise class (see generate_synthetic_noise.py).",
            }
        )
