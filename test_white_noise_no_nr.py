...
cfg['noise_reduction']['enabled'] = False  # DISABLE NOISE REDUCTION
...
sf.write('test_white_noise_no_nr.wav', noise, sr)

predictor = Predictor(cfg)
results = predictor.predict_file(Path('test_white_noise_no_nr.wav'), persist_outputs=False)
